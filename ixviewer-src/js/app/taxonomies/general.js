...
var TaxonomiesGeneral = {
  ...
  getTaxonomyListTemplate : function( elementID, modalAction ) {
    ...
    taxonomyLink.addEventListener('click', function(e) { TaxonomiesGeneral.goTo(e, e.delegateTarget, modalAction); });

    var elementId = element.getAttribute('id');
    if ( elementId ) {
      taxonomyLink.setAttribute('data-id', elementId);
      taxonomyLink.addEventListener('keyup', function(e) { TaxonomiesGeneral.goTo(e, e.delegateTarget, modalAction); });
